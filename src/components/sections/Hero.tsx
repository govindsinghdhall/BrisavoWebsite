...
export function Hero() {
  return (
    <section className="relative min-h-[80vh] sm:min-h-[85vh] flex items-start overflow-hidden mesh-gradient noise-overlay">
      ...
      <div className="container-wide relative z-10 px-[clamp(1.5rem,5vw,4rem)] pt-24 pb-12 sm:pt-28 sm:pb-14 md:pt-32">
        <div className="max-w-2xl">
          ...
          <h2 className="text-[1.625rem] min-[400px]:text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-semibold tracking-tight leading-[1.05] sm:leading-[0.95] mb-4 sm:mb-5">
          ...
          <BlurReveal immediate>
            <p className="text-sm sm:text-base md:text-lg text-muted max-w-lg leading-relaxed mb-2 sm:mb-3">
              A combination of brilliance and evolution.
            </p>
            <p className="text-xs sm:text-sm text-foreground/50 max-w-lg leading-relaxed mb-5 sm:mb-7">
              Our goal is to help businesses evolve through technology.
            </p>
          </BlurReveal>
